...
template<uint ndofs, uint ord, uint tord=2, uint hs=(ord-1)/2> void YAKL_INLINE weno_func(SArray<real,ndofs,ndims,2> &edgerecon, SArray<real,ndofs,ndims,ord> const &dens,
