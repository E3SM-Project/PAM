...
int n_cells_interfaces, n_cells_interfaces_with_halo;
...
void printinfo();
  ...
  void Topology::initialize(Parallel &par, bool isprimal)
  {
    ...
    this->n_cells_layers_with_halo = (this->n_cells_x + 2*this->halosize_x) * (this->n_cells_y + 2*this->halosize_y) * this->nl;
    this->n_cells_interfaces = this->n_cells_x * this->n_cells_y * this->nl;
    this->n_cells_interfaces_with_halo = (this->n_cells_x + 2*this->halosize_x) * (this->n_cells_y + 2*this->halosize_y) * this->nl;
  ...
  if (this->primal)
   ...
   std::cout << "halosize_x " << this->halosize_x << " halosize_y " << this->halosize_y << "\n" << std::flush;
   std::cout << "is " << this->is << " js " << this->js << "\n" << std::flush;
 }
  else
  {
