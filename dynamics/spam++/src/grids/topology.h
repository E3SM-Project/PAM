...
int n_cells_interfaces, n_cells_interfaces_internal, n_cells_interfaces_with_halo;
...
void printinfo();
  ...
  void Topology::initialize(Parallel &par, bool isprimal)
  {
    ...
    this->n_cells_layers_with_halo = (this->n_cells_x + 2*this->halosize_x) * (this->n_cells_y + 2*this->halosize_y) * (this->nl + 2*this->mirror_halo);
    this->n_cells_interfaces = this->n_cells_x * this->n_cells_y * this->ni;
    this->n_cells_interfaces_internal = this->n_cells_x * this->n_cells_y * (this->ni-2);
    this->n_cells_interfaces_with_halo = (this->n_cells_x + 2*this->halosize_x) * (this->n_cells_y + 2*this->halosize_y) * (this->ni + 2*this->mirror_halo);
  ...
  if (this->primal)
   ...
   std::cout << "nx " << this->n_cells_x << " ny " << this->n_cells_y << " nl " << this->nl << " ni " << this->ni << "\n" << std::flush;
   std::cout << "halosize_x " << this->halosize_x << " halosize_y " << this->halosize_y << " mirroring_halo " << this->mirror_halo << "\n" << std::flush;
