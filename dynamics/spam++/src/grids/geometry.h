...
template<uint number_of_dims, uint nquadx, uint nquady, uint nquadz> class UniformRectangularGeometry: public Geometry<ndims,nquadx,nquady,nquadz> {};
...
public:
  ...
  virtual void YAKL_INLINE get_dual_0form_quad_pts_wts(int i, SArray<coords<1>,1> &quad_pts_phys, SArray<real,1> &quad_wts_phys) {};
  virtual void YAKL_INLINE get_dual_1form_quad_pts_wts(int i, SArray<coords<1>,nquadx> &quad_pts_phys, SArray<real,nquadx> &quad_wts_phys) {};
  ...
  YAKL_INLINE void set_primal_0form_values(real (*initial_value_function)(real), Field &field, int ndof);
  YAKL_INLINE void set_primal_1form_values(real (*initial_value_function)(real), Field &field, int ndof);
  YAKL_INLINE void set_dual_0form_values(real (*initial_value_function)(real), Field &field, int ndof);
  YAKL_INLINE void set_dual_1form_values(real (*initial_value_function)(real), Field &field, int ndof);

};

template<uint nquadx, uint nquady, uint nquadz> class UniformRectangularGeometry<1,nquadx,nquady,nquadz>: public Geometry<1,nquadx,nquady,nquadz> {
...
public:
  ...
  void YAKL_INLINE get_dual_0form_quad_pts_wts(int i, SArray<coords<1>,1> &quad_pts_phys, SArray<real,1> &quad_wts_phys);
  void YAKL_INLINE get_dual_1form_quad_pts_wts(int i, SArray<coords<1>,nquadx> &quad_pts_phys, SArray<real,nquadx> &quad_wts_phys);
...
template<uint nquadx, uint nquady, uint nquadz> Geometry<1,nquadx,nquady,nquadz>::Geometry()
  ...
  template<uint nquadx, uint nquady, uint nquadz> YAKL_INLINE void Geometry<1,nquadx,nquady,nquadz>::set_primal_0form_values(real (*initial_value_function)(real), Field &field, int ndof)
{
  ...
  template<uint nquadx, uint nquady, uint nquadz> YAKL_INLINE void Geometry<1,nquadx,nquady,nquadz>::set_primal_1form_values(real (*initial_value_function)(real), Field &field, int ndof)
{
...
template<uint nquadx, uint nquady, uint nquadz> YAKL_INLINE void Geometry<1,nquadx,nquady,nquadz>::set_dual_0form_values(real (*initial_value_function)(real), Field &field, int ndof)
{
...
yakl::parallel_for("Set0FormValues", this->topology->n_cells, YAKL_LAMBDA (int iGlob) {
  int k, j, i;
  yakl::unpackIndices(iGlob, this->topology->n_cells_z, this->topology->n_cells_y, this->topology->n_cells_x ,k, j, i);
    get_dual_0form_quad_pts_wts(i, quad_pts_phys, quad_wts_phys);
    field.data(ndof+offset, k+ks, j+js, i+is) = initial_value_function(quad_pts_phys(0).x) * quad_wts_phys(0);
});
}

template<uint nquadx, uint nquady, uint nquadz> YAKL_INLINE void Geometry<1,nquadx,nquady,nquadz>::set_dual_1form_values(real (*initial_value_function)(real), Field &field, int ndof)
{
...
yakl::parallel_for("Set1FormValues", this->topology->n_cells, YAKL_LAMBDA (int iGlob) {
  ...
  get_dual_1form_quad_pts_wts(i, quad_pts_phys, quad_wts_phys);
  tempval = 0.0;
  for (int nqx=0; nqx<nquadx; nqx++) {
        tempval = tempval + initial_value_function(quad_pts_phys(nqx).x) * quad_wts_phys(nqx);
        }
...
template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularGeometry<1,nquadx,nquady,nquadz>::initialize(const Topology &topo, const ModelParameters &params)
{
...
template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularGeometry<1,nquadx,nquady,nquadz>::printinfo()
{
  std::cout << "uniform rectangular geometry 1D info\n" << std::flush;
...
template<uint nquadx, uint nquady, uint nquadz> real YAKL_INLINE UniformRectangularGeometry<1,nquadx,nquady,nquadz>::get_J_cell(int k, int j, int i)
{
  return this->dx;
}
...
template<uint nquadx, uint nquady, uint nquadz> real YAKL_INLINE UniformRectangularGeometry<1,nquadx,nquady,nquadz>::get_H_edge(int l, int k, int j, int i)
{
  return 1.0/this->dx;
}
...
template<uint nquadx, uint nquady, uint nquadz> void YAKL_INLINE UniformRectangularGeometry<1,nquadx,nquady,nquadz>::get_dual_0form_quad_pts_wts(int i, SArray<coords<1>,1> &quad_pts_phys, SArray<real,1> &quad_wts_phys)
{
  quad_pts_phys(0).x = (i+this->topology->i_beg)*this->dx + this->xc - this->Lx/2. + this->dx/2.;
  quad_wts_phys(0) = 1.;
}

template<uint nquadx, uint nquady, uint nquadz> void YAKL_INLINE UniformRectangularGeometry<1,nquadx,nquady,nquadz>::get_dual_1form_quad_pts_wts(int i, SArray<coords<1>,nquadx> &quad_pts_phys, SArray<real,nquadx> &quad_wts_phys)
{
...
public:
  ...
  virtual void YAKL_INLINE get_primal_edge_tangents(int i, int j, SArray<vec<2>,nquadx> &x_tangents, SArray<vec<2>,nquady> &y_tangents) {};
  virtual void YAKL_INLINE get_primal_edge_normals(int i, int j, SArray<vec<2>,nquadx> &x_normals, SArray<vec<2>,nquady> &y_normals) {};

  virtual void YAKL_INLINE get_dual_0form_quad_pts_wts(int i, int j, SArray<coords<2>,1> &quad_pts_phys, SArray<real,1> &quad_wts_phys) {};
  virtual void YAKL_INLINE get_dual_1form_quad_pts_wts(int i, int j, SArray<coords<2>,nquadx> &x_quad_pts_phys, SArray<real,nquadx> &x_quad_wts_phys, SArray<coords<2>,nquady> &y_quad_pts_phys, SArray<real,nquady> &y_quad_wts_phys) {};
  virtual void YAKL_INLINE get_dual_2form_quad_pts_wts(int i, int j, SArray<coords<2>,nquadx,nquady> &quad_pts_phys, SArray<real,nquadx,nquady> &quad_wts_phys) {};
  virtual void YAKL_INLINE get_dual_edge_tangents(int i, int j, SArray<vec<2>,nquadx> &x_tangents, SArray<vec<2>,nquady> &y_tangents) {};
  virtual void YAKL_INLINE get_dual_edge_normals(int i, int j, SArray<vec<2>,nquadx> &x_normals, SArray<vec<2>,nquady> &y_normals) {};

  virtual real YAKL_INLINE get_J_cell(int k, int j, int i) {};
  virtual real YAKL_INLINE get_J_dual_cell(int k, int j, int i) {};
  virtual real YAKL_INLINE get_H_edge(int l, int k, int j, int i) {};

  YAKL_INLINE void set_primal_0form_values(real (*initial_value_function)(real, real), Field &field, int ndof);
  YAKL_INLINE void set_primal_1form_values(vec<2> (*initial_value_function)(real, real), Field &field, int ndof, LINE_INTEGRAL_TYPE line_type);
  YAKL_INLINE void set_primal_2form_values(real (*initial_value_function)(real, real), Field &field, int ndof);

  YAKL_INLINE void set_dual_0form_values(real (*initial_value_function)(real, real), Field &field, int ndof);
  YAKL_INLINE void set_dual_1form_values(vec<2> (*initial_value_function)(real, real), Field &field, int ndof, LINE_INTEGRAL_TYPE line_type);
  YAKL_INLINE void set_dual_2form_values(real (*initial_value_function)(real, real), Field &field, int ndof);

};

template<uint nquadx, uint nquady, uint nquadz> class UniformRectangularGeometry<2,nquadx,nquady,nquadz>: public Geometry<2,nquadx,nquady,nquadz> {
...
public:
  ...
  void YAKL_INLINE get_primal_edge_tangents(int i, int j, SArray<vec<2>,nquadx> &x_tangents, SArray<vec<2>,nquady> &y_tangents);
  void YAKL_INLINE get_primal_edge_normals(int i, int j, SArray<vec<2>,nquadx> &x_normals, SArray<vec<2>,nquady> &y_normals);

  void YAKL_INLINE get_dual_0form_quad_pts_wts(int i, int j, SArray<coords<2>,1> &quad_pts_phys, SArray<real,1> &quad_wts_phys);
  void YAKL_INLINE get_dual_1form_quad_pts_wts(int i, int j, SArray<coords<2>,nquadx> &x_quad_pts_phys, SArray<real,nquadx> &x_quad_wts_phys, SArray<coords<2>,nquady> &y_quad_pts_phys, SArray<real,nquady> &y_quad_wts_phys);
  void YAKL_INLINE get_dual_2form_quad_pts_wts(int i, int j, SArray<coords<2>,nquadx,nquady> &quad_pts_phys, SArray<real,nquadx,nquady> &quad_wts_phys);
  void YAKL_INLINE get_dual_edge_tangents(int i, int j, SArray<vec<2>,nquadx> &x_tangents, SArray<vec<2>,nquady> &y_tangents);
  void YAKL_INLINE get_dual_edge_normals(int i, int j, SArray<vec<2>,nquadx> &x_normals, SArray<vec<2>,nquady> &y_normals);
...
template<uint nquadx, uint nquady, uint nquadz> Geometry<2,nquadx,nquady,nquadz>::Geometry()
  ...
  template<uint nquadx, uint nquady, uint nquadz> YAKL_INLINE void Geometry<2,nquadx,nquady,nquadz>::set_primal_0form_values(real (*initial_value_function)(real, real), Field &field, int ndof)
{
  ...
  template<uint nquadx, uint nquady, uint nquadz> YAKL_INLINE void Geometry<2,nquadx,nquady,nquadz>::set_primal_2form_values(real (*initial_value_function)(real, real), Field &field, int ndof)
{
  ...
  template<uint nquadx, uint nquady, uint nquadz>  YAKL_INLINE void Geometry<2,nquadx,nquady,nquadz>::set_primal_1form_values(vec<2> (*initial_value_function)(real, real), Field &field, int ndof, LINE_INTEGRAL_TYPE line_type)
  {
      ...
      yakl::parallel_for("Set1FormValues", this->topology->n_cells , YAKL_LAMBDA (int iGlob) {
        ...
        if (line_type == LINE_INTEGRAL_TYPE::TANGENT) {get_primal_edge_tangents(i, j, x_line_vec, y_line_vec);}
        if (line_type == LINE_INTEGRAL_TYPE::NORMAL) {get_primal_edge_normals(i, j, x_line_vec, y_line_vec);}
  ...
  template<uint nquadx, uint nquady, uint nquadz> YAKL_INLINE void Geometry<2,nquadx,nquady,nquadz>::set_dual_0form_values(real (*initial_value_function)(real, real), Field &field, int ndof)
{
  ...
  yakl::parallel_for("Set0FormValues", this->topology->n_cells, YAKL_LAMBDA (int iGlob) {
    ...
    yakl::unpackIndices(iGlob, this->topology->n_cells_z, this->topology->n_cells_y, this->topology->n_cells_x ,k, j, i);
      ...
      field.data(ndof+offset, k+ks, j+js, i+is) = initial_value_function(quad_pts_phys(0).x, quad_pts_phys(0).y) * quad_wts_phys(0);
  });
}

  template<uint nquadx, uint nquady, uint nquadz> YAKL_INLINE void Geometry<2,nquadx,nquady,nquadz>::set_dual_2form_values(real (*initial_value_function)(real, real), Field &field, int ndof)
{
  ...
  yakl::parallel_for("Set2FormValues", this->topology->n_cells, YAKL_LAMBDA (int iGlob) {
    ...
    get_dual_2form_quad_pts_wts(i, j, quad_pts_phys, quad_wts_phys);
    tempval = 0.0;
    for (int nqx=0; nqx<nquadx; nqx++) {
      for (int nqy=0; nqy<nquady; nqy++) {
          tempval = tempval + initial_value_function(quad_pts_phys(nqx, nqy).x, quad_pts_phys(nqx, nqy).y) * quad_wts_phys(nqx, nqy);
  ...
  template<uint nquadx, uint nquady, uint nquadz>  YAKL_INLINE void Geometry<2,nquadx,nquady,nquadz>::set_dual_1form_values(vec<2> (*initial_value_function)(real, real), Field &field, int ndof, LINE_INTEGRAL_TYPE line_type)
  {
      SArray<coords<2>,nquadx> x_quad_pts_phys;
      SArray<real,nquadx> x_quad_wts_phys;
      SArray<coords<2>,nquady> y_quad_pts_phys;
      ...
      yakl::parallel_for("Set1FormValues", this->topology->n_cells , YAKL_LAMBDA (int iGlob) {
        ...
        get_dual_1form_quad_pts_wts(i, j, x_quad_pts_phys, x_quad_wts_phys, y_quad_pts_phys, y_quad_wts_phys);

        if (line_type == LINE_INTEGRAL_TYPE::TANGENT) {get_dual_edge_tangents(i, j, x_line_vec, y_line_vec);}
        if (line_type == LINE_INTEGRAL_TYPE::NORMAL) {get_dual_edge_normals(i, j, x_line_vec, y_line_vec);}

        // compared to primal edges in 2D, they are stored x/y (V, -U) instead of y/x
      // y-edge
        tempval = 0.0;
      for (int nqy=0; nqy<nquady; nqy++) {
        initval = initial_value_function(y_quad_pts_phys(nqy).x, y_quad_pts_phys(nqy).y);
...
template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularGeometry<2,nquadx,nquady,nquadz>::initialize(const Topology &topo, const ModelParameters &params)
{
...
template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularGeometry<2,nquadx,nquady,nquadz>::printinfo()
{
  std::cout << "uniform rectangular geometry 2D info\n" << std::flush;
  std::cout << "Lx " << this->Lx << " Ly " << this->Ly << " Lz " << this->Lz << "\n" << std::flush;
  std::cout << "xc " << this->xc << " yc " << this->yc << " zc " << this->zc << "\n" << std::flush;
  std::cout << "dx " << this->dx << " dy " << this->dy << " dz " << this->dz << "\n" << std::flush;
}
...
template<uint nquadx, uint nquady, uint nquadz> real YAKL_INLINE UniformRectangularGeometry<2,nquadx,nquady,nquadz>::get_J_cell(int k, int j, int i)
{
...
template<uint nquadx, uint nquady, uint nquadz> real YAKL_INLINE UniformRectangularGeometry<2,nquadx,nquady,nquadz>::get_H_edge(int l, int k, int j, int i)
{
  if (l==0) {return this->dy/this->dx;};
  if (l==1) {return this->dx/this->dy;};
}
...
template<uint nquadx, uint nquady, uint nquadz> void YAKL_INLINE UniformRectangularGeometry<2,nquadx,nquady,nquadz>::get_dual_0form_quad_pts_wts(int i, int j, SArray<coords<2>,1> &quad_pts_phys, SArray<real,1> &quad_wts_phys)
{
  quad_pts_phys(0).x = (i+this->topology->i_beg)*this->dx + this->xc - this->Lx/2. + this->dx/2.;
...
template<uint nquadx, uint nquady, uint nquadz> void YAKL_INLINE UniformRectangularGeometry<2,nquadx,nquady,nquadz>::get_dual_2form_quad_pts_wts(int i, int j, SArray<coords<2>,nquadx,nquady> &quad_pts_phys, SArray<real,nquadx,nquady> &quad_wts_phys)
{
  real ll_corner_x = (i+this->topology->i_beg)*this->dx + this->xc - this->Lx/2. - this->dx/2.;
...
template<uint nquadx, uint nquady, uint nquadz> void YAKL_INLINE UniformRectangularGeometry<2,nquadx,nquady,nquadz>::get_dual_1form_quad_pts_wts(int i, int j, SArray<coords<2>,nquadx> &x_quad_pts_phys, SArray<real,nquadx> &x_quad_wts_phys, SArray<coords<2>,nquady> &y_quad_pts_phys, SArray<real,nquady> &y_quad_wts_phys)
{
    real ll_corner_x = (i+this->topology->i_beg)*this->dx + this->xc - this->Lx/2. - this->dx/2.;
    real ll_corner_y = (j+this->topology->j_beg)*this->dy + this->yc - this->Ly/2. - this->dy/2.;
    for (int nqx=0; nqx<nquadx; nqx++) {
...
template<uint nquadx, uint nquady, uint nquadz> void YAKL_INLINE UniformRectangularGeometry<2,nquadx,nquady,nquadz>::get_primal_edge_tangents(int i, int j, SArray<vec<2>,nquadx> &x_tangents, SArray<vec<2>,nquady> &y_tangents)
{
    for (int nqx=0; nqx<nquadx; nqx++)
    {
        x_tangents(nqx).u = -1.;
...
template<uint nquadx, uint nquady, uint nquadz> void YAKL_INLINE UniformRectangularGeometry<2,nquadx,nquady,nquadz>::get_primal_edge_normals(int i, int j, SArray<vec<2>,nquadx> &x_normals, SArray<vec<2>,nquady> &y_normals)
{
    for (int nqx=0; nqx<nquadx; nqx++)
    {
        x_normals(nqx).u = 0.;
...
// For dual edges in 2D, the primal tangent is the dual normal, and the dual normal is the primal tangent

template<uint nquadx, uint nquady, uint nquadz> void YAKL_INLINE UniformRectangularGeometry<2,nquadx,nquady,nquadz>::get_dual_edge_tangents(int i, int j, SArray<vec<2>,nquadx> &x_tangents, SArray<vec<2>,nquady> &y_tangents)
{
    for (int nqx=0; nqx<nquadx; nqx++)
    {
        x_tangents(nqx).u = 1.;
...
template<uint nquadx, uint nquady, uint nquadz> void YAKL_INLINE UniformRectangularGeometry<2,nquadx,nquady,nquadz>::get_dual_edge_normals(int i, int j, SArray<vec<2>,nquadx> &x_normals, SArray<vec<2>,nquady> &y_normals)
{
    for (int nqx=0; nqx<nquadx; nqx++)
    {
        x_normals(nqx).u = 0.;
