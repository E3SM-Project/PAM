...
template<uint nquadx, uint nquady, uint nquadz> void YAKL_INLINE UniformRectangularGeometry<2,nquadx,nquady,nquadz>::get_edge_tangents(int i, int j, SArray<vec<2>,nquadx> &x_tangents, SArray<vec<2>,nquady> &y_tangents)
{
    for (int nqx=0; nqx<nquadx; nqx++)
    {
        x_tangents(nqx).u = 1.;
...
template<uint nquadx, uint nquady, uint nquadz> void YAKL_INLINE UniformRectangularGeometry<2,nquadx,nquady,nquadz>::get_edge_normals(int i, int j, SArray<vec<2>,nquadx> &x_normals, SArray<vec<2>,nquady> &y_normals)
{
    for (int nqx=0; nqx<nquadx; nqx++)
    {
        x_normals(nqx).u = 0.;
  ...
  template<uint nquadx, uint nquady, uint nquadz> void YAKL_INLINE UniformRectangularGeometry<3,nquadx,nquady,nquadz>::get_edge_tangents(int i, int j, int k, SArray<vec<3>,nquadx> &x_tangents, SArray<vec<3>,nquady> &y_tangents, SArray<vec<3>,nquadz> &z_tangents)
  {
      for (int nqx=0; nqx<nquadx; nqx++)
      {
          x_tangents(nqx).u = 1.;
  ...
  template<uint nquadx, uint nquady, uint nquadz> void YAKL_INLINE UniformRectangularGeometry<3,nquadx,nquady,nquadz>::get_surface_normals(int i, int j, int k, SArray<vec<3>,nquadx,nquady> &xy_normals, SArray<vec<3>,nquady,nquadz> &yz_normals, SArray<vec<3>,nquadx,nquadz> &xz_normals)
  {
      for (int nqx=0; nqx<nquadx; nqx++) {
        for (int nqy=0; nqy<nquady; nqy++) {
