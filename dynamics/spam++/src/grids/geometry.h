...
if (npts == 4)
{
    pts(0) = -1./2.*sqrt(3./7. + 2./7. * sqrt(6./5.)) + 0.5;
    pts(1) = -1./2.*sqrt(3./7. - 2./7. * sqrt(6./5.)) + 0.5;
    pts(2) = 1./2.*sqrt(3./7. - 2./7. * sqrt(6./5.)) + 0.5;
    pts(3) = 1./2.*sqrt(3./7. + 2./7. * sqrt(6./5.)) + 0.5;
...
if (npts == 5)
{
    pts(0) = -1./6.*sqrt(5. + 2. * sqrt(10./7.)) + 0.5;
    pts(1) = -1./6.*sqrt(5. - 2. * sqrt(10./7.)) + 0.5;
    pts(2) = 0.5;
    pts(3) = 1./6.*sqrt(5. - 2. * sqrt(10./7.)) + 0.5;
    pts(4) = 1./6.*sqrt(5. + 2. * sqrt(10./7.)) + 0.5;
...
template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularTwistedGeometry<nquadx,nquady,nquadz>::initialize(const Topology &topo, const ModelParameters &params)
{
...
template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularStraightGeometry<nquadx,nquady,nquadz>::initialize(const Topology &topo, const ModelParameters &params)
{
...
template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularTwistedExtrudedGeometry<nquadx,nquady,nquadz>::initialize(const Topology &topo, const ModelParameters &params)
{
...
template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularStraightExtrudedGeometry<nquadx,nquady,nquadz>::initialize(const Topology &topo, const ModelParameters &params)
{
