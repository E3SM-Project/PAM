...
template<uint ndofs> void YAKL_INLINE weno(SArray<real,ndofs,ndims,2> &edgerecon, SArray<real,ndofs,ndims,3> const &dens) {
    for (int l=0; l<ndofs; l++) {
      for (int k=0; k<ndims; k++) {
          edgerecon(l,k,0) = interp_weno3(dens(l,k,2), dens(l,k,1), dens(l,k,0));
          edgerecon(l,k,1) = interp_weno3(dens(l,k,0), dens(l,k,1), dens(l,k,2));
        }
      }
}
...
template<uint ndofs> void YAKL_INLINE weno(SArray<real,ndofs,ndims,2> &edgerecon, SArray<real,ndofs,ndims,5> const &dens) {
    for (int l=0; l<ndofs; l++) {
      for (int k=0; k<ndims; k++) {
          edgerecon(l,k,0) = interp_weno5(dens(l,k,4), dens(l,k,3), dens(l,k,2), dens(l,k,1), dens(l,k,0));
          edgerecon(l,k,1) = interp_weno5(dens(l,k,0), dens(l,k,1), dens(l,k,2), dens(l,k,3), dens(l,k,4));
        }
      }
}
...
template<uint ndofs> void YAKL_INLINE weno(SArray<real,ndofs,ndims,2> &edgerecon, SArray<real,ndofs,ndims,7> const &dens) {
    for (int l=0; l<ndofs; l++) {
      for (int k=0; k<ndims; k++) {
          edgerecon(l,k,0) = interp_weno7(dens(l,k,6), dens(l,k,5), dens(l,k,4), dens(l,k,3), dens(l,k,2), dens(l,k,1), dens(l,k,0));
          edgerecon(l,k,1) = interp_weno7(dens(l,k,0), dens(l,k,1), dens(l,k,2), dens(l,k,3), dens(l,k,4), dens(l,k,5), dens(l,k,6));
        }
      }
}
...
template<uint ndofs> void YAKL_INLINE weno(SArray<real,ndofs,ndims,2> &edgerecon, SArray<real,ndofs,ndims,9> const &dens) {
    for (int l=0; l<ndofs; l++) {
      for (int k=0; k<ndims; k++) {
          edgerecon(l,k,0) = interp_weno9(dens(l,k,8), dens(l,k,7), dens(l,k,6), dens(l,k,5), dens(l,k,4), dens(l,k,3), dens(l,k,2), dens(l,k,1), dens(l,k,0));
          edgerecon(l,k,1) = interp_weno9(dens(l,k,0), dens(l,k,1), dens(l,k,2), dens(l,k,3), dens(l,k,4), dens(l,k,5), dens(l,k,6), dens(l,k,7), dens(l,k,8));
        }
      }
}
...
template<uint ndofs> void YAKL_INLINE weno(SArray<real,ndofs,ndims,2> &edgerecon, SArray<real,ndofs,ndims,11> const &dens) {
    for (int l=0; l<ndofs; l++) {
      for (int k=0; k<ndims; k++) {
          edgerecon(l,k,0) = interp_weno11(dens(l,k,10), dens(l,k,9), dens(l,k,8), dens(l,k,7), dens(l,k,6), dens(l,k,5), dens(l,k,4), dens(l,k,3), dens(l,k,2), dens(l,k,1), dens(l,k,0));
          edgerecon(l,k,1) = interp_weno11(dens(l,k,0), dens(l,k,1), dens(l,k,2), dens(l,k,3), dens(l,k,4), dens(l,k,5), dens(l,k,6), dens(l,k,7), dens(l,k,8), dens(l,k,9), dens(l,k,10));
        }
      }
}
#endif
