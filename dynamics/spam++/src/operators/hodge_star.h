...
template<uint ndofs, uint ord, uint off=ord/2 -1> void YAKL_INLINE compute_H(SArray<real,ndims> &u, const realArr vvar, Geometry<1,1,1> &pgeom, Geometry<1,1,1> &dgeom, int is, int js, int ks, int i, int j, int k)
{
...
template<uint ndofs, uint ord, ADD_MODE addmode=ADD_MODE::REPLACE, uint off=ord/2 -1> void YAKL_INLINE compute_H(realArr uvar, const realArr vvar, Geometry<1,1,1> &pgeom, Geometry<1,1,1> &dgeom, int is, int js, int ks, int i, int j, int k)
{
  SArray<real,ndims> u;
...
real YAKL_INLINE compute_Hv(const realArr wvar, Geometry<1,1,1> &pgeom, Geometry<1,1,1> &dgeom, int is, int js, int ks, int i, int j, int k)
{
...
template<uint ndofs, uint ord, ADD_MODE addmode=ADD_MODE::REPLACE, uint off=ord/2 -1> void YAKL_INLINE compute_Hv(realArr uwvar, const realArr wvar, Geometry<1,1,1> &pgeom, Geometry<1,1,1> &dgeom, int is, int js, int ks, int i, int j, int k)
{
...
template<uint ndofs, uint ord, ADD_MODE addmode=ADD_MODE::REPLACE, uint off=ord/2 -1> void YAKL_INLINE compute_Hv(SArray<real,1> &uwvar, const realArr wvar, Geometry<1,1,1> &pgeom, Geometry<1,1,1> &dgeom, int is, int js, int ks, int i, int j, int k)
{
  real uw = compute_Hv(wvar, pgeom, dgeom, is, js, ks, i, j, k);
  ...
  template<uint ndofs, uint ord, uint off=ord/2 -1> void YAKL_INLINE compute_Hext(SArray<real,ndims> &u, const realArr vvar, Geometry<1,1,1> &pgeom, Geometry<1,1,1> &dgeom, int is, int js, int ks, int i, int j, int k)
  {
    SArray<real,ndims,ord-1> v;
    SArray<real,ndims,ord-1> Hgeom;
    for (int p=0; p<ord-1; p++) {
...
template<uint ndofs, uint ord, ADD_MODE addmode=ADD_MODE::REPLACE, uint off=ord/2 -1> void YAKL_INLINE compute_Hext(realArr uvar, const realArr vvar, Geometry<1,1,1> &pgeom, Geometry<1,1,1> &dgeom, int is, int js, int ks, int i, int j, int k)
{
  SArray<real,ndims> u;
...
template<uint ndofs, uint ord, uint off=ord/2 -1> void YAKL_INLINE compute_I(SArray<real,ndofs> &x0, const realArr var, Geometry<1,1,1> &pgeom, Geometry<1,1,1> &dgeom, int is, int js, int ks, int i, int j, int k)
{
...
template<uint ndofs, uint ord, ADD_MODE addmode=ADD_MODE::REPLACE, uint off=ord/2 -1> void YAKL_INLINE compute_I(realArr var0, const realArr var, Geometry<1,1,1> &pgeom, Geometry<1,1,1> &dgeom, int is, int js, int ks, int i, int j, int k)
{
...
template<uint ndofs, uint hord,  uint vord, uint hoff=hord/2 -1, uint voff=vord/2 -1> void YAKL_INLINE compute_Iext(SArray<real,ndofs> &x0, const realArr var, Geometry<1,1,1> &pgeom, Geometry<1,1,1> &dgeom, int is, int js, int ks, int i, int j, int k)
{
SArray<real,ndofs,ndims,hord-1> x;
SArray<real,ndims,hord-1> Igeom;
...
template<uint ndofs, uint hord,  uint vord, ADD_MODE addmode=ADD_MODE::REPLACE, uint hoff=hord/2 -1, uint voff=vord/2 -1> void YAKL_INLINE compute_Iext(realArr var0, const realArr var, Geometry<1,1,1> &pgeom, Geometry<1,1,1> &dgeom, int is, int js, int ks, int i, int j, int k)
{
  SArray<real,ndofs> x0;
...
template<uint ndofs, uint ord, uint off=ord/2 -1> void YAKL_INLINE compute_J(SArray<real,ndofs> &x0, const realArr var, Geometry<1,1,1> &pgeom, Geometry<1,1,1> &dgeom, int is, int js, int ks, int i, int j, int k)
{
SArray<real,ndofs,ndims,ord-1> x;
...
template<uint ndofs, uint ord, ADD_MODE addmode=ADD_MODE::REPLACE, uint off=ord/2 -1> void YAKL_INLINE compute_J(realArr var0, const realArr var, Geometry<1,1,1> &pgeom, Geometry<1,1,1> &dgeom, int is, int js, int ks, int i, int j, int k)
{
  SArray<real,ndofs> x0;
...
template<uint ndofs, uint hord, uint vord, uint hoff=hord/2 -1, uint voff=vord/2 -1> void YAKL_INLINE compute_Jext(SArray<real,ndofs> &x0, const realArr var, Geometry<1,1,1> &pgeom, Geometry<1,1,1> &dgeom, int is, int js, int ks, int i, int j, int k)
{
SArray<real,ndofs,ndims,hord-1> x;
SArray<real,ndims,hord-1> Jgeom;
for (int p=0; p<hord-1; p++) {
for (int l=0; l<ndofs; l++) {
for (int d=0; d<ndims; d++) {
  if (d==0)
...
template<uint ndofs, uint hord,  uint vord, ADD_MODE addmode=ADD_MODE::REPLACE, uint hoff=hord/2 -1, uint voff=vord/2 -1> void YAKL_INLINE compute_Jext(realArr var0, const realArr var, Geometry<1,1,1> &pgeom, Geometry<1,1,1> &dgeom, int is, int js, int ks, int i, int j, int k)
{
  SArray<real,ndofs> x0;
