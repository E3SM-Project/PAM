...
template<uint ndims, uint ndofs> void YAKL_INLINE gradient2_add( realArr var, const realArr recon, const realArr dens, const Topology<ndims> &topology) {
...
template<uint ndims, uint ndofs> void YAKL_INLINE gradient4_add( realArr var, const realArr recon, const realArr dens, const Topology<ndims> &topology) {
...
template<uint ndims, uint ndofs> void YAKL_INLINE gradient6_add( realArr var, const realArr recon, const realArr dens, const Topology<ndims> &topology) {
...
template<uint ndims, uint ndofs> void YAKL_INLINE gradient8_add( realArr var, const realArr recon, const realArr dens, const Topology<ndims> &topology) {
