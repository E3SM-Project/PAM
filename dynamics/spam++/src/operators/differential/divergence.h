...
template<uint ndims, uint ndofs> void YAKL_INLINE divergence4( realArr var, const realArr recon, const realArr flux, const Topology<ndims> &topology) {
...
template<uint ndims, uint ndofs> void YAKL_INLINE divergence6( realArr var, const realArr recon, const realArr flux, const Topology<ndims> &topology) {
