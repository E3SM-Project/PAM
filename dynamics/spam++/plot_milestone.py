...
for time in Nlist:
    ...
    for recon_type in recon_types:
        for recon_order in recon_orders:
            ...
            dens = DSdict[simname].dens
            plt.subplot(nvert,nhoriz,l)
            plt.contourf(dens.isel(t=time,dens_ndofs=2,dual_ncells_z=0), cmap=plt.get_cmap('viridis'))
            plt.colorbar()
            plt.xlabel('x')
            plt.ylabel('y')
            plt.title(simname)
    ...
    for recon_type in recon_types:
        for recon_order in recon_orders:
            ...
            densfct = DSdict[simname].densfct
            plt.subplot(nvert,nhoriz,l)
            plt.contourf(densfct.isel(t=time,densfct_ndofs=0,dual_ncells_z=0), cmap=plt.get_cmap('viridis'))
            plt.colorbar()
            plt.xlabel('x')
            plt.ylabel('y')
            plt.title(simname)
    ...
    for recon_type in recon_types:
        for recon_order in recon_orders:
            ...
            densl = DSdict[simname].densl
            plt.subplot(nvert,nhoriz,l)
            plt.contourf(densl.isel(t=time,densl_ndofs=1,primal_ncells_z=0), cmap=plt.get_cmap('viridis'))
            plt.colorbar()
            plt.xlabel('x')
            plt.ylabel('y')
            plt.title(simname)
    ...
    for recon_type in recon_types:
        for recon_order in recon_orders:
            ...
            densl = DSdict[simname].densl
            plt.subplot(nvert,nhoriz,l)
            plt.contourf(densl.isel(t=time,densl_ndofs=2,primal_ncells_z=0), cmap=plt.get_cmap('viridis'))
            plt.colorbar()
            plt.xlabel('x')
            plt.ylabel('y')
            plt.title(simname)
