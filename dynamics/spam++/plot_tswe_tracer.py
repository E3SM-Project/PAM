...
tracer = DS.tracer
tracermin = DS.tracermin
tracermax = DS.tracermax
...
plot_stat('tracer', tracer)
plot_rawstat('tracermin', tracermin)
plot_rawstat('tracermax', tracermax)
...
for i in Nlist:
    ...
    plotvar_scalar2D('tr', tr.isel(t=i,tr_ndofs=0,ncells_z=0),i)
    plotvar_scalar2D('tr0', tr0.isel(t=i,tr0_ndofs=0,ncells_z=0),i)
