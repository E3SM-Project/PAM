...
void FileIO<nprog, nconst, ndiag, nstats>::initialize(
  ...
  //      {nc.create_var<real>( this->const_vars->fields_arr[i].name ,
  //      {"primal_nlayers","primal_ncells_y","primal_ncells_x", "nens"});}
  //     if (this->const_vars->fields_arr[i].extdof == 0)
  //     {nc.create_var<real>( this->const_vars->fields_arr[i].name ,
  //     {"primal_ninterfaces","primal_ncells_y","primal_ncells_x", "nens"});}
  //     }
  //    else {
  //     if (this->const_vars->fields_arr[i].extdof == 1)
  //     {nc.create_var<real>( this->const_vars->fields_arr[i].name ,
  //     {"dual_nlayers","dual_ncells_y","dual_ncells_x", "nens"});} if
  //     (this->const_vars->fields_arr[i].extdof == 0) {nc.create_var<real>(
  //     this->const_vars->fields_arr[i].name ,
  //     {"dual_ninterfaces","dual_ncells_y","dual_ncells_x", "nens"});}
  //     }
  ...
  //      {nc.create_var<real>( this->prog_vars->fields_arr[i].name , {"t",
  //      "primal_nlayers","primal_ncells_y","primal_ncells_x", "nens"});}
  ...
  //     {nc.create_var<real>( this->prog_vars->fields_arr[i].name , {"t",
  //     "dual_nlayers","dual_ncells_y","dual_ncells_x", "nens"});} if
  //     (this->prog_vars->fields_arr[i].extdof == 0) {nc.create_var<real>(
  //     this->prog_vars->fields_arr[i].name , {"t",
  //     "dual_ninterfaces","dual_ncells_y","dual_ncells_x", "nens"});}
  //     }
  ...
  //      {nc.create_var<real>( this->diag_vars->fields_arr[i].name , {"t",
  //      "primal_nlayers","primal_ncells_y","primal_ncells_x", "nens"});}
  ...
  //     {nc.create_var<real>( this->diag_vars->fields_arr[i].name , {"t",
  //     "dual_nlayers","dual_ncells_y","dual_ncells_x", "nens"});} if
  //     (this->diag_vars->fields_arr[i].extdof == 0) {nc.create_var<real>(
  //     this->diag_vars->fields_arr[i].name , {"t",
  //     "dual_ninterfaces","dual_ncells_y","dual_ncells_x", "nens"});}
  //     }
  ...
  //   {
  //     nc.create_dim( this->statistics->stats_arr[l].name + "_ndofs" ,
  //     this->statistics->stats_arr[l].ndofs ); nc.create_var<real>(
