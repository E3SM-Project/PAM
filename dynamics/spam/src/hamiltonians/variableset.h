...
#if defined(PAMC_CE) || defined(PAMC_MCErho) || defined(PAMC_MCErhod) || defined(PAMC_CEp) || defined(PAMC_MCErhop) || defined(PAMC_MCErhodp)
          dm_dens_dry(k, j, i, n) =
...
#elif defined(PAMC_CEp) || defined(PAMC_MCErhop) || defined(PAMC_MCErhodp) || defined(PAMC_AN) || defined(PAMC_MAN)
