...
void set_parameters(real gin)
{
 ...
 real YAKL_INLINE compute_IE(const real5d dens, int is, int js, int ks, int i, int j, int k, int n)
 {
  ...
  void YAKL_INLINE compute_dHsdx(real5d B, const real5d dens, const real5d geop, int is, int js, int ks, int i, int j, int k, int n)
  {
    ...
    B(0, k+ks, j+js, i+is, n) = geop0(0) + U + p * alpha - entropic_var * generalized_Exner;
...
// 
// 
//  real YAKL_INLINE compute_PE(const real5d dens, const real5d densfct, const real5d geop, int is, int js, int ks, int i, int j, int k)
//  {
// 
//    SArray<real,1,1> geop0;
...
//      real YAKL_INLINE compute_alpha(const real5d dens0, const real5d densfct0, int is, int js, int ks, int i, int j, int k, int n) {
//        return 1./(dens0(0, k+ks, j+js, i+is) + densfct0(0, k+ks, j+js, i+is) + densfct0(1, k+ks, j+js, i+is) + densfct0(2, k+ks, j+js, i+is));
//      }
// 
//      real YAKL_INLINE compute_entropic_var(const real5d dens0, const real5d densfct0, int is, int js, int ks, int i, int j, int k, int n) {
...
//      }
//      real YAKL_INLINE compute_qd(const real5d dens0, const real5d densfct0, int is, int js, int ks, int i, int j, int k, int n) {
...
//      }
//      real YAKL_INLINE compute_qv(const real5d dens0, const real5d densfct0, int is, int js, int ks, int i, int j, int k, int n) {
...
//      }
//      real YAKL_INLINE compute_ql(const real5d dens0, const real5d densfct0, int is, int js, int ks, int i, int j, int k, int n) {
...
//      }
//      real YAKL_INLINE compute_qi(const real5d dens0, const real5d densfct0, int is, int js, int ks, int i, int j, int k, int n) {
...
// 
// 
//  real YAKL_INLINE compute_IE(const real5d dens, const real5d densfct, int is, int js, int ks, int i, int j, int k, int n)
//  {
// 
//    SArray<real,1,2> dens0;
...
//  }
// 
//   void YAKL_INLINE compute_dHsdx(real5d B, real5d Bfct, const real5d dens0, const real5d densfct0, const real5d geop, int is, int js, int ks, int i, int j, int k, int n)
//   {
// 
//     SArray<real,1,1> geop0;
//     compute_I<1,diff_ord> (geop0, geop, *this->primal_geometry, *this->dual_geometry, is, js, ks, i, j, k);
...
// {
//   real YAKL_INLINE compute_IE(const real5d dens, const real5d densfct, int is, int js, int ks, int i, int j, int k)
//   {
//     SArray<real,2> dens0;
//     compute_I<2, diff_ord>(dens0, dens, *this->primal_geometry, *this->dual_geometry, is, js, ks, i, j, k);
...
//   }
// 
//    void YAKL_INLINE compute_dHsdx(real5d B, real5d Bfct, const real5d dens0, const real5d densfct0, const real5d geop, int is, int js, int ks, int i, int j, int k)
//    {
// 
//      SArray<real,1> geop0;
//      compute_I<1,diff_ord> (geop0, geop, *this->primal_geometry, *this->dual_geometry, is, js, ks, i, j, k);
