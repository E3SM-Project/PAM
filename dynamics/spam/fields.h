...
// extdof = 0,1 (0 = interfaces, 1=layers)
  ...
  {
      parallel_for( Bounds<5>(this->total_dofs, this->_nz +2*this->topology->mirror_halo,this->topology->n_cells_y+2*this->topology->halosize_y, this->topology->n_cells_x+2*this->topology->halosize_x, this->topology->nens) , YAKL_LAMBDA(int ndof, int k, int j, int i, int n) { 
  ...
  {
parallel_for( Bounds<4>(this->_nz +2*this->topology->mirror_halo,this->topology->n_cells_y+2*this->topology->halosize_y, this->topology->n_cells_x+2*this->topology->halosize_x, this->topology->nens) , YAKL_LAMBDA(int k, int j, int i, int n) { 
        this->data(ndof, k, j, i, n) = val;
    });    
  }
  ...
  {
      parallel_for( Bounds<4>(this->total_dofs,this->topology->n_cells_y+2*this->topology->halosize_y, this->topology->n_cells_x+2*this->topology->halosize_x, this->topology->nens) , YAKL_LAMBDA(int ndof, int j, int i, int n) { 
  ...
  {
parallel_for( Bounds<3>(this->topology->n_cells_y+2*this->topology->halosize_y, this->topology->n_cells_x+2*this->topology->halosize_x, this->topology->nens) , YAKL_LAMBDA(int j, int i, int n) { 
  this->data(ndof, this->_nz + this->topology->mirror_halo, j, i, n) = val;
    });    
  }
...
parallel_for( Bounds<4>(this->_nz +2*this->topology->mirror_halo,this->topology->n_cells_y+2*this->topology->halosize_y, this->topology->n_cells_x+2*this->topology->halosize_x, this->topology->nens) , YAKL_LAMBDA(int k, int j, int i, int n) { 
  ...
  parallel_for( Bounds<5>(this->total_dofs, this->_nz,this->topology->n_cells_y, this->topology->n_cells_x, this->topology->nens) , YAKL_LAMBDA(int ndof, int k, int j, int i, int n) { 
