...
// POSSIBLY NEED NUMBER_OF_DIMS ARGUMENT HERE?


// template<uint nquadx, uint nquady, uint nquadz> class Geometry {};
// template<uint nquadx, uint nquady, uint nquadz> class UniformRectangularTwistedGeometry: public Geometry<nquadx,nquady,nquadz> {};
// template<uint nquadx, uint nquady, uint nquadz> class UniformRectangularStraightGeometry: public Geometry<nquadx,nquady,nquadz> {};
// template<uint nquadx, uint nquady, uint nquadz> class UniformRectangularTwistedExtrudedGeometry: public Geometry<nquadx,nquady,nquadz> {};
// template<uint nquadx, uint nquady, uint nquadz> class UniformRectangularStraightExtrudedGeometry: public Geometry<nquadx,nquady,nquadz> {};
// 
...
// 
// 
// template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularStraightGeometry<1,nquadx,nquady,nquadz>::initialize(const Topology &topo, const Parameters &params)
// {
// 
...
// }
// 
// template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularTwistedGeometry<1,nquadx,nquady,nquadz>::initialize(const Topology &topo, const Parameters &params)
// {
// 
// Geometry<1,nquadx,nquady,nquadz>::initialize(topo);
// 
...
template<uint nquadx, uint nquady, uint nquadz> Geometry<nquadx,nquady,nquadz>::Geometry()
    {
      this->is_initialized = false;
      std::cout << "CREATED GEOMETRY\n";
    }

  template<uint nquadx, uint nquady, uint nquadz> void Geometry<nquadx,nquady,nquadz>::initialize(const Topology &topo)
  {
  ...
  template<uint nquadx, uint nquady, uint nquadz> YAKL_INLINE void Geometry<nquadx,nquady,nquadz>::set_0form_values(real (*initial_value_function)(real, real), Field &field, int ndof)
{
...
template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularTwistedGeometry<nquadx,nquady,nquadz>::initialize(const Topology &topo, const Parameters &params)
{

Geometry<nquadx,nquady,nquadz>::initialize(topo);
...
template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularTwistedGeometry<nquadx,nquady,nquadz>::printinfo()
{
...
template<uint nquadx, uint nquady, uint nquadz> real YAKL_INLINE UniformRectangularTwistedGeometry<nquadx,nquady,nquadz>::get_area_lform(int l, int d, int k, int j, int i)
{
  if (l == 0) {return 1.;}
  if (l == 1) {
...
template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularStraightGeometry<nquadx,nquady,nquadz>::initialize(const Topology &topo, const Parameters &params)
{
...
template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularStraightGeometry<nquadx,nquady,nquadz>::printinfo()
{
...
template<uint nquadx, uint nquady, uint nquadz> real YAKL_INLINE UniformRectangularStraightGeometry<nquadx,nquady,nquadz>::get_area_lform(int l, int d, int k, int j, int i)
{
  if (l == 0) {return 1.;}
  if (l == 1) {
...
template<uint nquadx, uint nquady, uint nquadz> Geometry<nquadx,nquady,nquadz>::Geometry()
  ...
  this->topology = &topo;
  set_ref_quad_pts_wts<real,nquadx>(this->x_quad_pts_ref, this->x_quad_wts_ref);
  set_ref_quad_pts_wts<real,nquadz>(this->v_quad_pts_ref, this->v_quad_wts_ref);
}

  template<uint nquadx, uint nquady, uint nquadz> YAKL_INLINE void Geometry<nquadx,nquady,nquadz>::set_00form_values(real (*initial_value_function)(real, real), Field &field, int ndof)
{
    int is = this->topology->is;
    int js = this->topology->js;
    int ks = this->topology->ks;
...
template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularTwistedExtrudedGeometry<nquadx,nquady,nquadz>::initialize(const Topology &topo, const Parameters &params)
{
...
template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularTwistedExtrudedGeometry<nquadx,nquady,nquadz>::printinfo()
{
  std::cout << "uniform rectangular geometry 2D info: twisted \n" << std::flush;
  std::cout << "Lx " << this->Lx << " Ly " << this->Ly << " Lz " << this->Lz << "\n" << std::flush;
  std::cout << "xc " << this->xc << " yc " << this->yc << " zc " << this->zc << "\n" << std::flush;
...
template<uint nquadx, uint nquady, uint nquadz> real YAKL_INLINE UniformRectangularTwistedExtrudedGeometry<nquadx,nquady,nquadz>::get_area_00entity(int k, int j, int i)
{ return 1.; }

template<uint nquadx, uint nquady, uint nquadz> real YAKL_INLINE UniformRectangularTwistedExtrudedGeometry<nquadx,nquady,nquadz>::get_area_01entity(int k, int j, int i)
{ 
...
template<uint nquadx, uint nquady, uint nquadz> real YAKL_INLINE UniformRectangularTwistedExtrudedGeometry<nquadx,nquady,nquadz>::get_area_10entity(int k, int j, int i)
{ return this->dx; }

template<uint nquadx, uint nquady, uint nquadz> real YAKL_INLINE UniformRectangularTwistedExtrudedGeometry<nquadx,nquady,nquadz>::get_area_11entity(int k, int j, int i)
{ 
  if (k==this->topology->ks || k == this->topology->nl-1+this->topology->ks) //corrects for half-cells at top and bottom
  { return this->dx * this->dz / 2.0;}
...
template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularStraightExtrudedGeometry<nquadx,nquady,nquadz>::initialize(const Topology &topo, const Parameters &params)
{
...
template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularStraightExtrudedGeometry<nquadx,nquady,nquadz>::printinfo()
{
  std::cout << "uniform rectangular geometry 2D info: straight \n" << std::flush;
  std::cout << "Lx " << this->Lx << " Ly " << this->Ly << " Lz " << this->Lz << "\n" << std::flush;
  std::cout << "xc " << this->xc << " yc " << this->yc << " zc " << this->zc << "\n" << std::flush;
...
template<uint nquadx, uint nquady, uint nquadz> real YAKL_INLINE UniformRectangularStraightExtrudedGeometry<nquadx,nquady,nquadz>::get_area_00entity(int k, int j, int i)
{return 1.;}

template<uint nquadx, uint nquady, uint nquadz> real YAKL_INLINE UniformRectangularStraightExtrudedGeometry<nquadx,nquady,nquadz>::get_area_01entity(int k, int j, int i)
{return this->dz;}

template<uint nquadx, uint nquady, uint nquadz> real YAKL_INLINE UniformRectangularStraightExtrudedGeometry<nquadx,nquady,nquadz>::get_area_10entity(int k, int j, int i)
{return this->dx;}
...
//     real Lx, Ly, Lz;
//     real xc, yc, zc;
//     void initialize(const Topology &topo, const  &params);
// 
//     void printinfo();
// 
...
// 
// 
//   template<uint nquadx, uint nquady, uint nquadz> void UniformRectangularGeometry<3,nquadx,nquady,nquadz>::initialize(const Topology &topo, const Parameters &params)
//   {
// 
