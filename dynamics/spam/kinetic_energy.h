...
// }
// 
// void initialize(Parameters &params, Geometry<ndims,1,1,1> &primal_geom, Geometry<ndims,1,1,1> &dual_geom)
// {
...
// }
// 
// real YAKL_INLINE compute_KE(const real5d v, const real5d dens, const real5d densfct, int is, int js, int ks, int i, int j, int k)
// {
// 
//   real KE, PE, IE;
...
// 
// 
//  void YAKL_INLINE compute_dKdv(real5d F, real5d K, real5d HE, const real5d v, const real5d U, const real5d dens0, const real5d densfct0, int is, int js, int ks, int i, int j, int k)
// {
//   SArray<real,1,2> D0;
//   SArray<real,1> he;
// 
...
// void YAKL_INLINE compute_dKddens(real5d B, real5d Bfct, const real5d K, int is, int js, int ks, int i, int j, int k)
// {
//   SArray<real,1> K0;
...
real YAKL_INLINE compute_KE(const real5d v, const real5d dens, int is, int js, int ks, int i, int j, int k, int n)
{
  ...
  //compute U = H v
  compute_H<1,diff_ord> (U, v, *this->primal_geometry, *this->dual_geometry, is, js, ks, i, j, k, n);

  // Compute h0 = I h needed for phi calcs
  compute_I<1,diff_ord> (h0, dens, *this->primal_geometry, *this->dual_geometry, is, js, ks, i, j, k, n);
  compute_I<1,diff_ord> (h0im1, dens, *this->primal_geometry, *this->dual_geometry, is, js, ks, i-1, j, k, n);
  if (ndims>=2) {compute_I<1,diff_ord> (h0jm1, dens, *this->primal_geometry, *this->dual_geometry, is, js, ks, i, j-1, k, n);}
  if (ndims>=3) {compute_I<1,diff_ord> (h0km1, dens, *this->primal_geometry, *this->dual_geometry, is, js, ks, i, j, k-1, n);}
...
{
  SArray<real,1,1> K0;
  compute_I<1, diff_ord>(K0, K, *this->primal_geometry, *this->dual_geometry, is, js, ks, i, j, k, n);
...
//  }
// 
//  real YAKL_INLINE compute_KE(const real5d v, const real5d dens, const real5d densfct, int is, int js, int ks, int i, int j, int k, int n)
//  {
// 
// 
//    real KE;
...
// 
//    // Compute h0 = I h needed for phi calcs
//    compute_I<1,diff_ord> (rhod0, dens, *this->primal_geometry, *this->dual_geometry, is, js, ks, i, j, k, n);
//    compute_I<1,diff_ord> (rhod0im1, dens, *this->primal_geometry, *this->dual_geometry, is, js, ks, i-1, j, k, n);
//    if (ndims>=2) {compute_I<1,diff_ord> (rhod0jm1, dens, *this->primal_geometry, *this->dual_geometry, is, js, ks, i, j-1, k, n);}
//    if (ndims>=3) {compute_I<1,diff_ord> (rhod0km1, dens, *this->primal_geometry, *this->dual_geometry, is, js, ks, i, j, k-1, n);}
//    compute_I<3,diff_ord> (rhos0im1, densfct, *this->primal_geometry, *this->dual_geometry, is, js, ks, i-1, j, k, n);
//    compute_I<3,diff_ord> (rhos0im1, densfct, *this->primal_geometry, *this->dual_geometry, is, js, ks, i-1, j, k, n);
//    if (ndims>=2) {compute_I<3,diff_ord> (rhos0jm1, densfct, *this->primal_geometry, *this->dual_geometry, is, js, ks, i, j-1, k, n);}
//    if (ndims>=3) {compute_I<3,diff_ord> (rhos0km1, densfct, *this->primal_geometry, *this->dual_geometry, is, js, ks, i, j, k-1, n);}
// 
//    //compute he = phi h0
...
// 
// 
//   void YAKL_INLINE compute_dKdv(real5d F, real5d K, real5d HE, const real5d v, const real5d U, const real5d dens0, const real5d densfct0, int is, int js, int ks, int i, int j, int k, int n)
//  {
// 
//    SArray<real,2,ndims,2> D0;
//    SArray<real,1,ndims> he;
...
//      if (d == 0)
//      {
//        D0(d,0) = dens0(0, k+ks, j+js, i+is, n) + densfct0(0, k+ks, j+js, i+is, n) + densfct0(1, k+ks, j+js, i+is) + densfct0(2, k+ks, j+js, i+is);
//        D0(d,1) = dens0(0, k+ks, j+js, i+is-1, n) + densfct0(0, k+ks, j+js, i+is-1, n) + densfct0(1, k+ks, j+js, i+is-1) + densfct0(2, k+ks, j+js, i+is-1);
//      }
//      if (d == 1)
//      {
...
//  void YAKL_INLINE compute_dKddens(real5d B, real5d Bfct, const real5d K, int is, int js, int ks, int i, int j, int k, int n)
//  {
//    SArray<real,1,1> K0;
//    compute_I<1, diff_ord>(K0, K, *this->primal_geometry, *this->dual_geometry, is, js, ks, i, j, k);
//    B(0, k+ks, j+js, i+is) += K0(0);
