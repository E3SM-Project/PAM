...
subroutine crm(lchnk, icol, ncrms, dt_gl, plev, &
    ...
    integer(crm_iknd) , intent(in   ) :: lchnk                            ! chunk identifier (only for lat/lon and random seed)
    ...
    integer(crm_iknd) , intent(in   ) :: icol                (ncrms)      ! column identifier (only for lat/lon and random seed)
