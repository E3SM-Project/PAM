...
contains
  ...
  real(8) function dtqsatw_crm(t,p)
    !$acc routine seq
    implicit none
    real(8) t  ! temperature (K)
    real(8) p  ! pressure    (mb)
  ...
  real(8) function dtqsati_crm(t,p)
    !$acc routine seq
    implicit none
    real(8) t  ! temperature (K)
    real(8) p  ! pressure    (mb)
