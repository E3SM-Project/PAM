...
contains
  ...
  subroutine precip_init(tabs0, pres, rho, accrsi, accrsc, coefice, evaps1, evaps2, accrgi, accrgc, evapg1, evapg2, &
    ...
    use sat_mod
    implicit none
    real(8), intent(in   ) :: tabs0  (ncrms,nzm)
    real(8), intent(in   ) :: pres   (ncrms,nzm)
    real(8), intent(in   ) :: rho    (ncrms,nzm)
    real(8), intent(  out) :: accrsi (ncrms,nzm)
    real(8), intent(  out) :: accrsc (ncrms,nzm)
    real(8), intent(  out) :: coefice(ncrms,nzm)
    real(8), intent(  out) :: evaps1 (ncrms,nzm)
    real(8), intent(  out) :: evaps2 (ncrms,nzm)
    real(8), intent(  out) :: accrgi (ncrms,nzm)
    real(8), intent(  out) :: accrgc (ncrms,nzm)
    real(8), intent(  out) :: evapg1 (ncrms,nzm)
    real(8), intent(  out) :: evapg2 (ncrms,nzm)
    real(8), intent(  out) :: accrrc (ncrms,nzm)
    real(8), intent(  out) :: evapr1 (ncrms,nzm)
    real(8), intent(  out) :: evapr2 (ncrms,nzm)
