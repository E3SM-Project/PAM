...
contains
  ...
  subroutine ice_fall( qcl, qci, tabs, adz, dz, rho, q, t, precsfc, precssfc, dtn, fac_cond, fac_fus, ncrms, nx, ny, nzm )
    implicit none
    real(8), intent(in   ) :: qcl     (ncrms,nx,ny,nzm)
    real(8), intent(in   ) :: qci     (ncrms,nx,ny,nzm)
    ...
    real(8) omnu, omnc, omnd, qiu, qic, qid, tmp_theta, tmp_phi
