...
#ifdef SCREAM_CONFIG_IS_CMAKE_STOPITPLEASE
     , elapsed_s &
#endif
  ...
  do k=1,nlev
    do i=1,shcol
      ...
      if (Tl1_1 .le. 0._rtype) then
         write(err_msg,*)'ERROR: Tl1_1<0 before shoc_assumed_pdf_compute_qs k:',k,' Tl1_1 is:',Tl1_1
         call endscreamrun(err_msg)
      endif

      if (Tl1_2 .le. 0._rtype) then
         write(err_msg,*)'ERROR: Tl1_2<0 before shoc_assumed_pdf_compute_qs k:',k,' Tl1_2 is:',Tl1_2
         call endscreamrun(err_msg)
      endif
